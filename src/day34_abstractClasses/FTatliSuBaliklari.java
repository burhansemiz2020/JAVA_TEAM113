...
public class FTatliSuBaliklari extends EBalik{
    ...
    /*
    Abstract classlarin comnstructor lari vardir.
    Ama obje olusturulamaz.

    Abstract classlar data turu secilip concrete
    child classlarin constructorlari kullanilarak
    Abstract parent class ozelliklerinde objeler
    olusturulabilir.
     */
